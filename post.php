        ...
        <div class="content-wrap">
            ...
            <?php if ($this->options->WechatQR || $this->options->AlipayQR) : ?>
                <div class="free-reward">
                    <button class="btn btn-pay"><?php i18n('Donate') ?></button>
            ...
            <footer class="post-footer">
                <div class="post-nav-next post-nav-item"><i class="iconfont icon-prev-m"></i><?php $this->thePrev('%s', _i18n('Nothing')); ?></div>
                <div class="post-nav-prev post-nav-item"><?php $this->theNext('%s', _i18n('Nothing')); ?><i class="iconfont icon-next-m"></i></div>
            </footer>
            </article>
