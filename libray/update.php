...
class Update
{
  ...
  public static function getVersion()
  {
    ...
    echo "<style>.theme-info{ text-align:center; margin:1em 0; } .theme-info > *{ margin:0 0 1rem } .buttons a{ background:#467b96; color:#fff; border-radius:4px; padding:.5em .75em; display:inline-block }</style>"
      ...
      . "<h2>" . $pkg['name'] . "</h2>"
      . "<p>" . $pkg['description'] . "</p>"
      . "<p>By: <a href='https://github.com/starsareintherose/Typecho-Malacologist' target='_blank'>starsareintherose</a> | <a href='https://github.com/starsareintherose/Typecho-Malacologist/issues' target='_blank'>建议&反馈</a></p>"
  ...
  public static function checkVersion()
  {
    ...
    var uper = setInterval(function() {
      ...
      $.ajax({
        type: 'GET',
        url: 'https://raw.githubusercontent.com/starsareintherose/Typecho-Malacologist/master/package.json',
        dataType: 'json',
