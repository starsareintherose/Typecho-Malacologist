...
function themeConfig($form)
{
    ...
    /* Social account */
    $ORCIDLink = new Typecho_Widget_Helper_Form_Element_Text('ORCIDLink', NULL, NULL, _t('ORCID'), _i18n('请填入完整链接'));
    $form->addInput($ORCIDLink);
    $ResearchGateLink = new Typecho_Widget_Helper_Form_Element_Text('ResearchGateLink', NULL, NULL, _t('ResearchGate'), _i18n('请填入完整链接'));
    $form->addInput($ResearchGateLink);
    $EmailLink = new Typecho_Widget_Helper_Form_Element_Text('EmailLink', NULL, NULL, _t('Email'), _i18n('请填入完整链接'));
